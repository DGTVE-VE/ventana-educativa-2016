...
<div class="row margenInferior">
    <div id="carouselEducaplay" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            ...
            <li data-target="#carouselEducaplay" data-slide-to="1"></li>
            <li data-target="#carouselEducaplay" data-slide-to="2"></li>
        </ol>

        <!-- Wrapper for slides -->
        <div class="carousel-inner">
            <div class="item active">
                <img src="{{asset('imagenes/educaplay/series/ciudad_de_los_dioses.png')}}" alt="...">
            ...
            <div class="item">
                <img src="{{asset('imagenes/educaplay/series/las_culturas.png')}}" alt="...">
                <div class="carousel-caption posicionDescripcion">
                    <div class="col-sm-8 col-md-8 col-md-8">
                        Descripción
                    </div>
            ...
            <div class="item">
                <img src="{{asset('imagenes/educaplay/series/el_saber_del_deporte.png')}}" alt="...">
                <div class="carousel-caption posicionDescripcion">
                    <div class="col-sm-8 col-md-8 col-md-8">
                        Descripción
                    </div>
