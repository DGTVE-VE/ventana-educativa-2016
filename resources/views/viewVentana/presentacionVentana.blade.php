...
<div class="container">
    <div id="presentacion" class="carousel slide">
        <div class="carousel-inner">           
            ...
            <div class="item">
                <img class="image-responsive" src="imagenes/ventana/presentacion/lamina5.png" alt="Slide2">
            </div>  
            <div class="item">
                <img class="image-responsive" src="imagenes/ventana/presentacion/lamina6.png" alt="Slide2">
            </div>  
            <div class="item">
                <img class="image-responsive" src="imagenes/ventana/presentacion/lamina7.png" alt="Slide2">
            </div>  
            <div class="item">
                <img class="image-responsive" src="imagenes/ventana/presentacion/lamina8.png" alt="Slide2">
            </div>    
            <div class="item">
                <img class="image-responsive" src="imagenes/ventana/presentacion/lamina9.png" alt="Slide2">
            </div>  
            <div class="item">
