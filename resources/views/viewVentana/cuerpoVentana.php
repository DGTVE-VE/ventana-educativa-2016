	...
	/*	---------------------------------------	Secci�n Usabilidad. Agregar animaci�n de entrada a imagenes 	--------------------------------*/
		...
		function quitaEfxDifumina(clase){
			var elems = $(clase);    //elementos que quiero saber si estan en el �rea visible
			elems.each(function(){
				$(this).removeClass("difumina");
			});
		}
		function muestraCubos(){
			var Intervalo4 = $('.Intervalo4');    //elementos que quiero saber si estan en el �rea visible
			...
			var Intervalo3 = $('.Intervalo3');    //elementos que quiero saber si estan en el �rea visible
			...
			var Intervalo2 = $('.Intervalo2');    //elementos que quiero saber si estan en el �rea visible
			...
			var Intervalo1 = $('.Intervalo1');    //elementos que quiero saber si estan en el �rea visible
		...
		$(document).ready(function(){
			$(function(){
				var elems = $('.oculta');    //elementos que quiero saber si estan en el �rea visible
				elems.each(function(){
					$(this).fadeOut();
				});
				muestraCubos();
