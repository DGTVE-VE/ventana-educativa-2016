				...
				<div class="col-xs-10 col-sm-10 col-xs-offset-1 col-sm-offset-1" style="padding: 20%;">
					...
					<td>
						...
						<map name="mapacubosm07" id="mapacubosm07">
							...
							<area shape="poly" coords="0,548,548,1160,0,1160" onmouseover="cambiaImgFoto('SM06')" onmouseout="cambiaImgCubo('SM06')" href="#"/>
							<area shape="poly" coords="548,0,1160,0,1160,548" onmouseover="cambiaImgFoto('SM08')" onmouseout="cambiaImgCubo('SM08')" href="#"/>
