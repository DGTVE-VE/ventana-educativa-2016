...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 social " style="padding-top: 8.9%; padding-left:0; padding-right:0;">
            
                <ul>
                    <li><a href="#" class=""><i class="fa fa-twitter fa-2x" id="r1" ></i></a></li>
                    <li><a href="#" class=""><i class="fa fa-facebook fa-2x" id="r2" ></i></a></li>
                    <li><a href="#" class=""><i class="fa fa-youtube-play fa-2x" id="r3"></i></a></li>
                </ul>
