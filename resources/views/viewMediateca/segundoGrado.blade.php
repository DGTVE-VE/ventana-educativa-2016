...
@section('cuerpoMediateca')
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<map name="mapaSegundoGdo" id="mapaSegundoGdo">
			<area alt="formacionCivica" href="{{(url('educamedia/telesecundaria/2/20/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'formacionCivica')" onmouseout="normalImgSecu('segundoGrado', 'formacionCivica')" shape="poly" coords="12,162,106,196,99,242,108,294,15,329,3,287,0,227" />
			<area alt="orientacion" href="{{(url('educamedia/telesecundaria/2/24/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'orientacion')" onmouseout="normalImgSecu('segundoGrado', 'orientacion')" shape="poly" coords="15,162,105,194,123,162,146,138,166,118,119,32,89,53,57,81,33,119" />
			<area alt="historia" href="{{(url('educamedia/telesecundaria/2/21/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'historia')" onmouseout="normalImgSecu('segundoGrado', 'historia')" shape="poly" coords="121,33,169,117,200,104,235,99,266,100,280,2,202,1,157,15" />
			<area alt="espanol" href="{{(url('educamedia/telesecundaria/2/19/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'espanol')" onmouseout="normalImgSecu('segundoGrado', 'espanol')" shape="poly" coords="265,100,282,1,326,13,373,37,405,64,429,88,350,147,330,126,303,109" />
			<area alt="matematicas" href="{{(url('educamedia/telesecundaria/2/23/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'matematicas')" onmouseout="normalImgSecu('segundoGrado', 'matematicas')" shape="poly" coords="349,149,432,87,462,138,475,173,481,208,483,240,384,241,381,204,366,169" />
			...
			<area alt="lengua" href="{{(url('educamedia/telesecundaria/2/22/0'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'lengua')" onmouseout="normalImgSecu('segundoGrado', 'lengua')" shape="poly" coords="350,336,427,397,407,420,375,443,345,461,289,480,269,382,300,371,322,358" />
			<area alt="educacionFisica" href="{{(url('educamedia/telesecundaria/2/17/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'educacionFisica')" onmouseout="normalImgSecu('segundoGrado', 'educacionFisica')" shape="poly" coords="268,384,288,479,215,482,185,477,155,468,122,453,170,367,201,380,240,384" />
			<area alt="artes" href="{{(url('educamedia/telesecundaria/2/13/1'))}}" title="" onmouseover="resaltaImgSecu('segundoGrado', 'artes')" onmouseout="normalImgSecu('segundoGrado', 'artes')" shape="poly" coords="16,329,110,294,125,326,147,350,173,367,120,454,82,430,40,381" />
		</map>
