<style>
	...
	.ArtesII{
		position:absolute; top:155%; left:30%; width:28%; height: 64%;
	}
	.FormacionCivicaI{
		position: absolute; top:101%; left:23.5%; width:28%; height: 64%;
	}
	.OrientacionII{
		position:absolute; top:48.5%; left:29.5%; width:28%; height: 64%;
	}
	.HistoriaI{
		position:absolute; top:26%; left:47.7%; width:28%; height: 64%;
	}
	.EspanolII{
		position: absolute; top:33%; left:71.3%; width:28%; height: 64%;
	}
	.MatematicasII{
		position:absolute; top:69%; left:82.2%; width:28%; height: 64%;
	}
	.CienciasII{
		position:absolute; top:131%; left:82.5%; width:28%; height: 64%;
	}
	.InglesII{
		position: absolute; top:167%; left:71.7%; width:28%; height: 64%;
	}
	.EducacionFisicaII{
		position:absolute; top:174%; left:49%; width:28%; height: 64%;
	}
</style>
