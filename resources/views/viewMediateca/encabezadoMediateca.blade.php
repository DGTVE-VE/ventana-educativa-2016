                        ...
                        <ul class="dropdown-menu image-responsive menuVentanaApps">
                            <table class="">
                                <tr>
                                    <td class="divApp centered">
                                        <a class="text-center" href="{{url('ventana_educativa')}}">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appVentana.png','logo Ventana Educativa',['class'=>'img-responsive'])}}
                                        </a>
                                    ...
                                    <td class="divApp centered">
                                        <a class="text-center" href="http://redmite.televisioneducativa.gob.mx/" target="_blank">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appRed.png','logo Red Mesoamericana',['class'=>'img-responsive'])}}
                                        </a>
                                    ...
                                    <td class="divApp centered">
                                        <a class="text-center" href="http://mx.televisioneducativa.gob.mx" target="_blank">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appMexico.png','logo MexicoX',['class'=>'img-responsive'])}}
                                        </a>
                                ...
                                <tr>
                                    <td class="divApp centered" style="vertical-align:middle !important;">
                                        <a class="text-center" target="_blank" href="http://www.ibe.tv/es/canal/iberoamericano/756/Iberoam%C3%A9rica-al-d%C3%ADa-1032016.htm">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appIbero.png','logo Canal Iberoamericano',['class'=>'img-responsive'])}}
                                        </a>
                                        <label class="etiquetaApp text-center">Canal <br> Iberoamericano</label>
                                    </td>
                                    <td class="divApp centered">
                                        <a class="" href="#">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appDocentes.png','logo Docentes',['class'=>'img-responsive'])}}
                                        </a>
                                        <label class="etiquetaApp text-center center-block">Docentes</label>
                                    </td>
                                    <td class="divApp centered">
                                        <a class="" href="#">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appIdiomas.png','logo Idiomas',['class'=>'img-responsive'])}}
                                        </a>
                                ...
                                <tr>
                                    <td class="divApp centered">
                                        <a class="" href="#">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appMediateca.png','logo Mediateca',['class'=>'img-responsive'])}}
                                        </a>
                                        <label class="etiquetaApp text-center center-block">Mediateca</label>
                                    </td>
                                    <td class="divApp centered">
                                        <a class="" href="#">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appPadres.png','logo Padres',['class'=>'img-responsive'])}}
                                        </a>
                                        <label class="etiquetaApp text-center center-block">Padres</label>
                                    </td>
                                    <td class="divApp centered">
                                        <a class="" href="#">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appPrimaria.png','logo Primaria',['class'=>'img-responsive'])}}
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="divApp centered center-block">
                                        <a class="" href="#">
                                            {{ HTML::image('imagenes/mediateca/encabezado/appVOD.png','logo VOD',['class'=>'img-responsive'])}}
                                        </a>
