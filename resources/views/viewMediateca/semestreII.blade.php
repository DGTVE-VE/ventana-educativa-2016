...
@section('cuerpoMediateca')
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<map name="mapaSemII" id="mapaSemII">
			...
			<area alt="" onmouseover="resaltaImgSecu('SemestreII','HistoriaMexicoI')" onmouseout="normalImgSecu('SemestreII','HistoriaMexicoI')" title="" href="{{(url('educamedia/telebachillerato/II/10'))}}" shape="poly" coords="285,104,316,12,352,25,374,39,397,55,420,76,448,112,466,149,471,164,376,192,357,154,326,124" />
