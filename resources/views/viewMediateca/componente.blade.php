...
@section('cuerpoMediateca')
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center textoTitulo">
		<p><a href="{{ url('educamedia') }}"> EDUCAMEDIA </a> / <a href="{{url('educamedia/telebachillerato')}}"> TELEBACHILLERATO </a> / <a href="{{ url('educamedia/telebachillerato/Propedéutico') }}">{{ strtoupper($breadcrumbs) }}</a></p><br>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<map name="mapaSemPedagogico" id="mapaSemPedagogico">
			<area alt="cienciasSaludII" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/35/0'))}}" onmouseover="resaltaImgSecu('componente','CienciasSaludII')" onmouseout="normalImgSecu('componente','CienciasSaludII')" shape="poly" coords="8,182,104,207,119,168,140,138,170,119,120,32,92,47,68,70,47,96,24,134" />
			<area alt="cienciasSaludI" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/34/0'))}}" onmouseover="resaltaImgSecu('componente','CienciasSaludI')" onmouseout="normalImgSecu('componente','CienciasSaludI')" shape="poly" coords="121,32,172,115,210,103,245,98,278,103,306,6,279,3,263,1,201,1,158,17" />
			<area alt="cienciasComunicacionI" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/32/0'))}}" onmouseover="resaltaImgSecu('componente','CienciasComunicacionI')" onmouseout="normalImgSecu('componente','CienciasComunicacionI')" shape="poly" coords="281,103,308,8,324,14,348,24,374,40,399,58,421,78,453,123,367,171,347,141,315,118" />
			<area alt="cienciasComunicacionII" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/33/0'))}}" onmouseover="resaltaImgSecu('componente','CienciasComunicacionII')" onmouseout="normalImgSecu('componente','CienciasComunicacionII')" shape="poly" coords="369,173,454,125,471,159,478,186,483,216,483,270,476,306,380,282,386,244,383,211" />
			<area alt="probabilidadI" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/36/0'))}}" onmouseover="resaltaImgSecu('componente','ProbabilidadI')" onmouseout="normalImgSecu('componente','ProbabilidadI')" shape="poly" coords="380,283,475,308,462,348,439,382,417,408,395,432,365,453,314,367,347,341,369,311" />
			<area alt="probabilidadII" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/37/0'))}}" onmouseover="resaltaImgSecu('componente','ProbabilidadII')" onmouseout="normalImgSecu('componente','ProbabilidadII')" shape="poly" coords="361,452,313,369,284,380,246,386,205,382,182,476,219,482,269,483,317,474" />
			<area alt="psicologiaII" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/39/0'))}}" onmouseover="resaltaImgSecu('componente','PsicologiaII')" onmouseout="normalImgSecu('componente','PsicologiaII')" shape="poly" coords="119,315,33,364,59,401,94,433,117,449,179,475,204,382,172,368,134,339" />
			<area alt="psicologiaI" title="" href="{{(url('educamedia/telebachillerato/Propedéutico/38/0'))}}" onmouseover="resaltaImgSecu('componente','PsicologiaI')" onmouseout="normalImgSecu('componente','PsicologiaI')" shape="poly" coords="117,315,34,362,12,319,3,273,1,209,7,183,101,209,96,237,102,282" />
		</map>
