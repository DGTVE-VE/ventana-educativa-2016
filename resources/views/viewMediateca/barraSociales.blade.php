<div class="col-md-1 col-lg-1 derechaSociales">
    <ul class="sociales">
        ...
        <li class="margenAbajo"><a href="https://www.youtube.com/user/tveducativamx?feature=sub_widget_1" target="_blank" class="cambiacolorredesSociales"><span class="padRight"><i class="fa fa-youtube-play fa-2x" id="cy"></i></span></a></li>
    </ul>
</div>
