...
@section('cuerpoMediateca')
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<map name="mapaPrimerGdo" id="mapaPrimerGdo">
			<area alt="artes" href="{{(url('educamedia/telesecundaria/1/1/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'artes')" onmouseout="normalImgSecu('primerGrado', 'artes')" shape="poly" coords="15,329,110,295,124,323,146,349,172,369,121,455,78,424,37,378" />
			...
			<area alt="orientacion" href="{{(url('educamedia/telesecundaria/1/11/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'orientacion')" onmouseout="normalImgSecu('primerGrado', 'orientacion')" shape="poly" coords="15,327,107,293,98,250,105,196,12,161,2,197,1,267" />
			...
			<area alt="espanol" href="{{(url('educamedia/telesecundaria/1/7/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'espanol')" onmouseout="normalImgSecu('primerGrado', 'espanol')" shape="poly" coords="120,32,168,118,186,110,212,103,238,96,266,101,282,2,212,1,184,6,158,14" />
			<area alt="matematicas" href="{{(url('educamedia/telesecundaria/1/10/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'matematicas')" onmouseout="normalImgSecu('primerGrado', 'matematicas')" shape="poly" coords="281,3,268,103,315,121,350,147,431,89,392,49,348,21" />
			<area alt="ciencias" href="{{(url('educamedia/telesecundaria/1/5/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'ciencias')" onmouseout="normalImgSecu('primerGrado', 'ciencias')" shape="poly" coords="353,149,434,92,465,146,480,196,483,239,384,242,382,203,369,171" />
			<area alt="lengua" href="{{(url('educamedia/telesecundaria/1/9/0'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'lengua')" onmouseout="normalImgSecu('primerGrado', 'lengua')" shape="poly" coords="386,244,483,242,475,309,461,355,432,394,432,397,353,338,371,305,384,272" />
			<area alt="educacionFisica" href="{{(url('educamedia/telesecundaria/1/6/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'educacionFisica')" onmouseout="normalImgSecu('primerGrado', 'educacionFisica')" shape="poly" coords="351,339,428,400,406,424,356,458,295,479,292,477,271,386,307,371,334,352" />
		</map>
