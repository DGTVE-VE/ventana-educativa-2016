...
@section('cuerpoMediateca')
	...
	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-4 col-sm-offset-4 col-md-offset-4 col-lg-offset-4">
		<map name="mapaPrimerGdo" id="mapaPrimerGdo">
			...
			<area alt="" href="{{(url('educamedia/telesecundaria/1/7/1'))}}" title="" onmouseover="resaltaImgSecu('primerGrado', 'espanol')" onmouseout="normalImgSecu('primerGrado', 'espanol')" shape="poly" coords="169,117,215,101,265,101,280,0,195,4,152,16,122,32,267,99" />
