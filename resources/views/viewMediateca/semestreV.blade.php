...
@section('cuerpoMediateca')
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="contenedorAro">
			...
			{{HTML::image('imagenes/mediateca/tbachillerato/imgCentral/geografiaI.gif','Telebachillerato Central',['class'=>' img-responsive iniImgCentro', 'id'=>'GeografiaCentro'])}}
			{{HTML::image('imagenes/mediateca/tbachillerato/imgCentral/historiaUniv.gif','Telebachillerato Central',['class'=>' img-responsive iniImgCentro', 'id'=>'HistoriaUnivCentro'])}}
