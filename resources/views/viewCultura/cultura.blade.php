            ...
            <table class="table table-responsive text-center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="#" class="hvr-grow-shadow" target="_blank" ><br><img class="animated zoomIn img-responsive" src="{{asset('imagenes/cultura/pais/colombia.png')}}"/></a><br><br></td>                                                
                    ...
                    <tr>
                        ...
                        <td><a href="http://www.mexicoescultura.com/" target="_blank" class="hvr-grow-shadow"><img class="animated zoomIn img-responsive" src="{{asset('imagenes/cultura/pais/mexico.png')}}"/></a><br><br></td>
                        <td><a href="http://www.inc.gob.ni/" target="_blank" class="hvr-grow-shadow"><img class="animated zoomIn img-responsive" src="{{asset('imagenes/cultura/pais/nicaragua.png')}}"/></a><br><br></td>
                        <td><a href="http://www.inac.gob.pa/" target="_blank" class="hvr-grow-shadow"><img class="animated zoomIn img-responsive" src="{{asset('imagenes/cultura/pais/panama.png')}}"/></a><br><br></td>                        
                    </tr>                    
                    <tr>
                        <td><a href="http://cultura.gob.do/" target="_blank" class="hvr-grow-shadow"><img class="animated zoomIn img-responsive" src="{{asset('imagenes/cultura/pais/republicadominicana.png')}}"/></a><br><br></td>
                    </tr>                           
                </tbody>
            </table>
        </div>
