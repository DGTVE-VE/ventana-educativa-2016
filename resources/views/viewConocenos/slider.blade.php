...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
	<div class="row">
		<div class="col-xs-12 col-md-12"style="padding:50px;"></div>
	</div>
	...
	<ul id="scene2" class="scene" style="position:absolute; top:100px; left:250px; width:100%">
        ...
        <div class="row" style="margin:0px;">
			<div class="col-xs-8 col-xs-offset-1 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
        ...
        <div class="row textoSeccionSlider" style="margin:0px;">
			 <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 altura50Celda" onclick="tranformaFigura(1)" id="contenedorClic1">
				<a class="first after txtNegro acomodaLigas punteroMano" id="contenedorTxt1">Colaboradores</a>
			</div>
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 altura50Celda" onclick="tranformaFigura(2)" id="contenedorClic2">
				<a class="first after txtNegro acomodaLigas punteroMano enfasis" id="contenedorTxt2">Antecedentes</a>
			</div>
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 altura50Celda" onclick="tranformaFigura(3)" id="contenedorClic3">
		...
		<div class="row" style="position:relative; top:0px;">
			<div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-1 col-md-8 col-md-offset-1 col-lg-8 col-lg-offset-1">
