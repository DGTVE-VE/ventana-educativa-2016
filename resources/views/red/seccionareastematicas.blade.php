			...
			<div class="row fondo_Claro">
				...
				<div class="col-sm-6 col-md-3">
					<table> <!--class="popover-inner" title="Modelos y ambientes educativos" data-toggle="popover" data-placement="bottom" data-trigger="hover" 
							...
							<ul>
								...
								<li>Diseñ desarrollo de sistemas educativos innovadores.</li>
							</ul>
							"-->
						<tr>
							<td class="imgTabla"><a href="#">
				...
				<div class="col-sm-6 col-md-3">
					<table> <!--title="Gestion y calidad de programas educativos" data-toggle="popover" data-placement="left" data-trigger="hover" 
							...
							y documentación de buenas práicas internacionales y regionales. De igual manera, identificar las problemáticas de los procesos 
							de gestió aseguramiento de la calidad.<br>
							Se identifican las siguientes lías:<br><br>
							<ul>
								<li>Gestión de sistemas educativos con articulacióe las modalidades y entornos fícos y virtuales.</li>
								<li>Evaluació calidad en sistemas y ambientes educativos.</li>
			...
			<div class="row fondo_Claro">
				<div class="col-sm-6 col-md-4 col-md-offset-2">
					<table> <!--title="Multimedia y desarrollo educativo" data-toggle="popover" data-placement="right" data-trigger="hover" 
							data-content="Se explicarán y analizará las variables que intervienen en los procesos educativos, entre ellos: el desarrollo cognitivo, 
