<div class="navbar navbar-default" role="navigation" style="height:110px; margin:0px; margin:0px;">	<!--navbar-static-top-->
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#">Recientes Proyectos</a></li>
            <li><a href="#">Modelo de Usabilidad</a></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-justify">
        Integrar un espacio permanente de investigación y tecnología educativa de la mano de un equipo de colaboradores 
