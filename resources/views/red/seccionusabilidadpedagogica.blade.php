			...
			<div class="row fondo_Claro">
				...
				<!--	-------------------------------		Elementos para resolucion pequeña	------------------------	-->
				...
				<!--	-------------------------------		Elementos para resolución media - grande	--------------------------	-->
					<div  class="hidden-xs hidden-sm">
						<img id="txtFuncionalidad" class="estoy-visible slideInLeft " alt="" src="imagenes/red/ModeloUsabilidad/texto1-01.png" style="width:270px; height:52px; position:relative; top:-20px; left:140px;">
						<!--p>A partir de criterios de usabilidad pedagógica evaluar los recursos y herramientas tecnologicas que se implementen como apoyo al aprendizaje de los estudiantes.</p-->
					</div>
					<div class="hidden-xs hidden-sm">
				...
				<div class="col-xs-9 col-sm-2 col-md-3 col-lg-3" style="height:490px;">
				<!--	-------------------------------		Elementos para resolucion Extra pequeña	------------------------	-->
				...
				<!--	-------------------------------		Elementos para resolucion pequeña	------------------------	-->
					<div class="visible-sm-block text-justify" style="width:270px; position: relative; top:-50px; left:-150px;">
