					...
					<div id="carouselRetos" class="carousel slide" data-ride="carousel"> <!-- background-color:#E5E5E5; -->
					  ...
					  <div class="carousel-inner" role="listbox">
						<div class="item active">
						  <img src="imagenes/red/iconosRetos/1.png" class="imgIconosRetos" alt="...">
						...
						<div class="item">
						  <img src="imagenes/red/iconosRetos/2.png" class="imgIconosRetos" alt="...">
						...
						<div class="item">
						  <img src="imagenes/red/iconosRetos/3.png" class="imgIconosRetos" alt="...">
						  <div class="txtCarouselAbajo">
						...
						<div class="item">
						  <img src="imagenes/red/iconosRetos/4.png" class="imgIconosRetos" alt="...">
						  <div class="txtCarouselAbajo">
