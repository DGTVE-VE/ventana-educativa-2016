    ...
    <div class="col-xs-12 col-sm-6 col-md-2">
        ...
        <div class="col-md-12">
            <img class="img-responsive col-md-7 text-center" style="width: 90px; height: 50px;" src="imagenes/red/footer/ceccsica.png"/>
            <img class="img-responsive col-md-5 text-center" src="imagenes/red/footer/csuca.png"/>            
        </div>
        <div class="col-md-12">
            <br>
