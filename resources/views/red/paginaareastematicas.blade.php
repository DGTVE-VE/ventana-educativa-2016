    ...
    <div class="row" style="margin-top: 10%; background-image: url'';" >        
        ...
        <div class="col-md-10">
            <table class="table table-responsive">
                ...
                <tr>
                    <td><img src="imagenes/red/areasTematicas/gestionycalidaddeprogramaseducativos-blanco.png"></td>
                    <td>
                        <ul>
                ...
                <tr>
                    <td><img src="imagenes/red/areasTematicas/multimediaydesarrolloeducativo-blanco.png"></td>
                    <td>
                        <ul>
                ...
                <tr>
                    <td>
                        <img src="imagenes/red/areasTematicas/politicaeducativaycambiosocial-blanco.png"></td>
                    <td>
                        <ul>
