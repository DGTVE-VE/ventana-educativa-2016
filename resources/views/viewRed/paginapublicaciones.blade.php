                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="todos">                        
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                                <a href="{{url('publicacionesRed/mexico/cienciastecnologiasculturas.pdf')}}"  target="_blank">
                                   {{ HTML::image('publicacionesRed/mexico/imagenesthumbnails/mexico01.jpg','tecnologías y cultura', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/mexico/forointerregionalinvestigacionsobreeva.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/mexico/imagenesthumbnails/mexico02.jpg','foro interregional', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/mexico/modelostecnoeducativos.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/mexico/imagenesthumbnails/mexico03.jpg','modelos educativos', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                    ...
                    <div class="row">
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/mexico/territorioseducación.pdf')}}" target="_blank">
                             {{ HTML::image('publicacionesRed/mexico/imagenesthumbnails/mexico04.jpg','territorios educativos', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/mexico/usabilidadpedagogicatic.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/mexico/imagenesthumbnails/mexico05.jpg','usabilidad pedagogica', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            ...
                            {{ HTML::image('publicacionesRed/guatemala/imagenesthumbnails/guatemala01.jpg','programacin matematica', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}   
                            </a>
                            <ul class="list-group list-group-flush text-center">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/guatemala/enseñanzaaprendizajelectura.pdf')}}" target="_blank">
                             {{ HTML::image('publicacionesRed/guatemala/imagenesthumbnails/guatemala02.jpg','aprendizaje lectura', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}   
                             </a>
                            <ul class="list-group list-group-flush text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/elsalvador/enseñanzaaprendizajelectura.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/elsalvador/imagenesthumbnails/elsalvador01.jpg','aprendizaje lectura', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                                <li class="list-group-item text-justify">Título: Enseñanza - Aprendizaje de la Lectura</li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/honduras/expresioncomprensionlectora.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/honduras/imagenesthumbnails/honduras01.jpg','comprension lectora', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/honduras/enseñanzaaprendizajematematicas.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/honduras/imagenesthumbnails/honduras02.jpg','enseñanza matematica', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                         </a>
                            <ul class="list-group list-group-flush text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/panama/españolmatematica.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/panama/imagenesthumbnails/panama01.jpg','español-matematica', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                               </a>
                            <ul class="list-group list-group-flush text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/repdominicana/compresionlectora.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/repdominicana/imagenesthumbnails/repdominicana01.jpg','comprension lectora', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                            </a>
                            <ul class="list-group list-group-flush text-center">
                        ...
                        <div class="col-md-4 hvr-pulse-grow animated bounceIn">
                            <a href="{{url('publicacionesRed/repdominicana/enseñanzaaprendizajematematica.pdf')}}" target="_blank">
                                {{ HTML::image('publicacionesRed/repdominicana/imagenesthumbnails/repdominicana02.jpg','aprendizaje matematica', array('class'=>'image-responsive', 'width' => 400, 'height' => 251))}}
                                </a>
                            <ul class="list-group list-group-flush text-center">
                                <li class="list-group-item text-justify">Título: Enseñanza - aprendizaje de la matemática</li>
