...
@section('cuerpoRedmite')
	...
	<div class="row backpaquienes txtQuienesSomos" style="padding-top:2%; padding-bottom:2%;">
		...
		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5" style="padding-left:5%">
			...
			<ul>
				...
				<li class=" list-unstyled"><span class="fa fa-minus" style="text-align: justify;"></span> Fomentar el desarrollo de habilidades digitales para el docente ante la era digital.</li>
				<li class=" list-unstyled"><span class="fa fa-minus" style="text-align: justify;"></span> Impulsar a través de este espacio la profesionalización, actualización e innovación del docente
									ante el nuevo contexto tecnológico.</li>
				<li class=" list-unstyled"><span class="fa fa-minus" style="text-align: justify;"></span> Crear aportes científicos que favorezcan a nuevas metodologías y tendencias para el proceso de
									enseñanza y aprendizaje.</li>
				<li class=" list-unstyled"><span class="fa fa-minus" style="text-align: justify;"></span> Proveer al docente de recursos que le permitan articular desde su labor, la configuración de la
									comunidad escolar (alumno-profesor-padre de familia.</li>
