...
class RedBlogController extends Controller
{
    ...
    public function index (){
        ...
        return view('viewRed/blog/list', compact ('blogs', 'colaboradores', 'recientes', 'leidos','comentados'));
    }
    ...
    public function store (Request $request){
        ...
        return Redirect::to ('redmite/blog');
    }
    ...
    public function create (){
        ...
        return view('viewRed/blog/create');
    }
...
//        dd($colaborador);
    ...
    public function comment (){
        ...
        $comment->save();
        return redirect('redmite/blog/'.$comment->id_blog);
    }
